...
- [ ] **M18-003:** Build a room list and room creation flow. The list exists; creating a room and putting somebody in one is still an application's decision made with a key, and this is what makes it a person's.
