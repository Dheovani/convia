...
- [ ] **M18-023:** Invite somebody on another installation, by a link carrying the inviting installation's address and the invitee's handle. The invitee proves they hold the key their identifier is the fingerprint of. To decide with the product owner before building: what the link contains and how long it lasts, what happens when the inviting installation is not reachable, where a call between two installations is held, and whether two people compare a short verification code on first contact.
