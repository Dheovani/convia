...
- **Next implementation milestone:** the invitation slice that finishes M10, now that the join session it was waiting for exists, then M14 — Real-Time Control Events
