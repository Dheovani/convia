...
- [ ] **M31-006:** Add keyset pagination over history, in both directions. Implemented in the store and the service, cursor being the sequence itself; unchecked until an HTTP surface makes it reachable.
- [ ] **M31-007:** Define read state, and decide whether it is durable or advisory.
- [ ] **M31-008:** Publish `message.*` control events, and decide which of them are durable.
- [ ] **M31-009:** Define per-person authorization, which is the first real use of a session principal.
- [ ] **M31-010:** Bound message size, rate, and history growth.
- [ ] **M31-011:** Define retention and erasure, consistent with the boundaries M06 set for users.
- [ ] **M31-012:** Add integration tests over ordering, pagination, and concurrent authorship.
