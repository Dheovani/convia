...
- [ ] **M31-001:** Decide what a conversation is, and whether it is the same thing as a room.
- [ ] **M31-002:** Define a message: authorship, ordering, and what Convia is authoritative for.
- [ ] **M31-003:** Decide the ordering guarantee, and what a client may assume about it.
- [ ] **M31-004:** Define editing and deletion, including what remains visible afterwards.
- [ ] **M31-005:** Define attachments, or record why they are deferred.
- [ ] **M31-006:** Add keyset pagination over history, in both directions.
